  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <Input id="email" type="email" {...register('email')} placeholder="john@ccl.gov.in" />
      ...
      <div className="space-y-2">
        ...
        <Input id="uniqueCode" {...register('uniqueCode')} placeholder="Enter 9-digit code" />
      ...
      <div className="space-y-2">
        ...
        <div className="flex gap-4 items-center">
          <div className="bg-muted px-4 py-2 rounded font-mono text-lg tracking-widest select-none line-through decoration-primary/50 italic">
            {captchaText}
          </div>
          <Button type="button" variant="outline" size="sm" onClick={generateCaptcha}>Refresh</Button>
        </div>
        <Input id="captcha" {...register('captcha')} placeholder="Enter captcha above" />
